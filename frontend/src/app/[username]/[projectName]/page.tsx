        ...
        <>
            ...
            <div className="max-w-7xl mx-auto min-h-screen px-6 py-8 grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-8">
                <main className="space-y-10">
                    <section>
                        <h1 className="text-3xl font-bold">{project.name.split('/').pop()}</h1>

                        <h2 className="text-xl font-semibold mt-10 mb-4">Timeline</h2>
                        ...
                        <div className="flex flex-col gap-4 relative before:absolute before:left-2 before:top-0 before:bottom-0 before:w-px before:bg-neutral-200">
                            ...
                            {devlogs.length === 0 && (
                                <div className="opacity-60 pl-8">No devlog events yet.</div>
                            )}
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="prose max-w-none border rounded-xl p-6 bg-white">
                            {project.readme ? (
                                ...
                                <div className="opacity-60">No README provided.</div>
                            )}
                        </div>
                    </section>
                </main>
                ...
                <aside className="space-y-4">
                    <div className="border rounded-xl p-4 bg-gray-50">
                        ...
                        <div className="font-medium">{project.user?.username}</div>

                        <div className="mt-4 text-sm text-neutral-500">About</div>
