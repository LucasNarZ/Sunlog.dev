...
const Profile = () => {
	...
	const saveProfile = async () => {
		...
		try {
			...
			const response = await apiClient.put('/user/update', updatedUser, {
						...
						{isEditing ? (
							<div className="flex flex-col gap-3">
								...
								<div>
									<input
										...
										onChange={(e) =>
											handleImgUrlChange(e.target.value)
										}
							...
							<>
								...
								<div className="flex gap-7">
									<button
										onClick={toggleEdit}
										className="cursor-pointer mt-4 px-5 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition"
									>
										Edit Profile
									</button>
					...
					{posts && posts.length > 0 ? (
						...
						<div className="flex flex-col items-center justify-center text-center mt-10 gap-4">
							...
							<p className="text-gray-500">
								Start writing and share your knowledge with
								others!
							</p>
							<button
								onClick={handleClick}
