...
export function MarkdownEditor({
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-96 flex-1 w-full flex flex-col sm:flex-row relative overflow-hidden rounded-xl border border-gray-300"
    >
      <div
      ...
      >
        ...
        />
        {errors.content && (
          <p className="text-danger text-sm p-2">{errors.content.message}</p>
        )}
      </div>
